...
public class UserDetailsActivity extends BaseActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener {
    ...
    public void AsignarCampos(People people){
        // Establece los valores en los EditTexts
        editTextId.setText(people.getId());
        editTextNombre.setText(people.getName());
        editTextApellido.setText(people.getSurname());
        editTextEdad.setText(people.getAge());
    }
